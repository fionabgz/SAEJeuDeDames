        ...
        */
        ...
        do {
            ...
            do {
                ...
                indColonneArrivee = Methodes.indiceColonne(chaine.charAt(0));
                indLigneArrivee = Methodes.indiceLigne(chaine.charAt(1));
            } while (!Methodes.saisieCorrecte(chaine) || !Methodes.deplacementPossible(damier, indiceLigne, indiceColonne, indLigneArrivee, indColonneArrivee) || damier[indLigneArrivee][indColonneArrivee] != Damier.VIDE);
            Methodes.deplacement(damier, indiceLigne, indiceColonne, indLigneArrivee, indColonneArrivee);
        }while(Methodes.prisePossible(damier,indLigneArrivee,indLigneArrivee));
    }
